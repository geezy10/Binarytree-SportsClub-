...
public class Main {
    public static void main(String[] args) {
        ...
        Football.addMember(new Trainer("Bob", 4));
        Football.addMember(new TopAthlete("Charlie", 2));

        Section Tennis = new Section("Tennis");
        Tennis.addMember(new AmateurAthlete("Felix", 4));
        Tennis.addMember(new Trainer("Greta", 4));
        Tennis.addMember(new TopAthlete("Hans", 5));
        AbstractMember schusi = new AmateurAthlete("Schusi", 3);
